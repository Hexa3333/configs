...
-- Make super tab work as expected
...
cmp.setup {
  ...
  formatting = {
    -- ORDERING FOR THE COMPLETION DROP DOWN MENU
    --          emoji   text   [type]
  ...
  experimental = {
    ghost_text = false, -- highlights currently selected completion
    native_menu = false,
  },
}
